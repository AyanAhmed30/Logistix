          ...
          <Input
            ...
            placeholder={
              meta.searchMode === "customers"
                ? "Search customers…"
                : meta.searchMode === "vendors"
                  ? "Search vendors…"
                  : meta.searchMode === "credit-notes"
                    ? "Search credit notes…"
                    : meta.searchMode === "vendor-refunds"
                      ? "Search vendor refunds…"
                      : meta.searchMode === "refunds"
                        ? "Search refunds…"
                        : meta.searchMode === "payments"
                          ? "Search payments…"
                          : meta.searchMode === "vendor-payments"
                            ? "Search vendor payments…"
                            : meta.searchMode === "products"
                              ? "Search products…"
                              : meta.searchMode === "bills"
                                ? "Search bills…"
                                : meta.searchMode === "journal-entries"
                                  ? "Search journal entries…"
                                  : meta.searchMode === "reconcile"
                                    ? "Search outstanding entries…"
                                    : meta.searchMode === "assets"
                                      ? "Search assets…"
                                      : meta.searchMode === "loans"
                                        ? "Search loans…"
                                        : meta.searchMode === "tax-returns"
                                          ? "Search tax returns…"
                                          : meta.searchMode === "chart-of-accounts"
                                            ? "Search by code or name…"
                                            : meta.searchMode === "journals"
                                              ? "Search journals…"
                                              : meta.searchMode === "taxes"
                                                ? "Search taxes…"
                                                : meta.searchMode === "payment-terms"
